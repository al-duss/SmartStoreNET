...
namespace SmartStore.Services.Tests.Customers
{
    ...
    public class CustomerServiceTest : ServiceTest
    {
        ...
        private void TestCustomerFirstAndLastName(string firstName, string lastName)
        {
            ...
            var pages = _customerService.GetAllCustomers(null, null, null, string.Empty, string.Empty,firstName, lastName, 0, 0, string.Empty, string.Empty, string.Empty,false,null, 0,2);
        ...
        private void TestAllCustomersByPage(int pageIndex)
        {
            ...
            var pages = _customerService.GetAllCustomers(null, null, null, string.Empty, string.Empty, string.Empty, string.Empty, 0, 0, string.Empty, string.Empty, string.Empty, false, null, pageIndex, 2);
        ...
        private void TestCustomerEmail()
        {
            ...
            var pages = _customerService.GetAllCustomers(null, null, null, "notregistered@test.com", string.Empty, string.Empty, string.Empty, 0, 0, string.Empty, string.Empty, string.Empty, false, null, 0,5);
            Assert.AreEqual(1, pages.Count);
        }
    }
}